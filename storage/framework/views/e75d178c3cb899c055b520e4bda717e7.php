...
<div class="space-y-6">
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="p-6 text-gray-900">
            <h3 class="text-lg font-semibold mb-2">ようこそ、<?php echo e(auth()->user()->name); ?>さん</h3>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app_3/resources/views/admin/dashboard/simple.blade.php ENDPATH**/ ?>