  ...
  <div class="container mx-auto p-4">
    ...
    <div class="flex justify-between items-center mb-6 bg-white rounded-lg shadow-sm p-4">
      ...
      <div class="flex items-center space-x-4">
        ...
        <?php elseif(auth('customer')->check()): ?>
          <!-- 顧客ログイン中 -->
          <div class="flex items-center space-x-3">
            <div class="flex items-center space-x-2">
              ...
              <div class="text-sm">
                <p class="font-medium text-gray-700"><?php echo e(auth('customer')->user()->name); ?></p>
                <p class="text-gray-500"><?php echo e(auth('customer')->user()->email); ?></p>
