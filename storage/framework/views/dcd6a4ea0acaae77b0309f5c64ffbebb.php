      ...
      <div class="mt-16">
        ...
        <div class="mb-8">
          <a href="<?php echo e(route('calendar.public')); ?>"
            class="scale-100 p-6 bg-blue-50 dark:bg-blue-800/20 dark:bg-gradient-to-bl from-blue-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-blue-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-blue-500 group">
            <div>
              <div class="h-16 w-16 bg-blue-100 dark:bg-blue-800/30 flex items-center justify-center rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  class="w-7 h-7 stroke-blue-600 group-hover:stroke-blue-700">
                  <path stroke-linecap="round" stroke-linejoin="round"
                    d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5a2.25 2.25 0 002.25-2.25m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5a2.25 2.25 0 002.25 2.25v7.5m-18 0h18" />
                </svg>
              </div>

              <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">予約カレンダー</h2>

              <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                こちらから予約可能な日時を確認し、ご予約いただけます。カレンダーで空き状況をご確認の上、お気軽にご予約ください。
              </p>
            </div>

            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              class="self-center shrink-0 stroke-blue-600 group-hover:stroke-blue-700 w-6 h-6 mx-6">
...
<?php /**PATH /var/www/html/app_3/resources/views/welcome.blade.php ENDPATH**/ ?>