<?php $__env->startSection('title', 'システム設定'); ?>
          ...
          <div>
            ...
            <div class="flex items-center space-x-3">
              ...
              <input type="number" name="reservation_advance_days"
                value="<?php echo e(old('reservation_advance_days', $settings['reservation_advance_days'])); ?>" min="0"
                max="365"
            ...
            <?php $__errorArgs = ['reservation_advance_days'];
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app_3/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>