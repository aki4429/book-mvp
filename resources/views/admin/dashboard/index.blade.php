        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p id="total-users" class="text-2xl font-bold text-gray-900">{{ $stats['total_users'] }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p id="total-customers" class="text-2xl font-bold text-gray-900">{{ $stats['total_customers'] }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p id="total-reservations" class="text-2xl font-bold text-gray-900">{{ $stats['total_reservations'] }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p id="active-timeslots" class="text-2xl font-bold text-gray-900">{{ $stats['active_timeslots'] }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div id="period-stats" class="space-y-4">
                <div class="flex justify-between items-center">
                    ...
                    <span id="period-reservations" class="font-semibold text-gray-900">{{ $todayStats['today_reservations'] }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-600">時間枠数</span>
                    <span id="period-timeslots" class="font-semibold text-gray-900">{{ $todayStats['today_timeslots'] }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-600">利用可能枠数</span>
                    <span id="period-available-slots" class="font-semibold text-gray-900">{{ $todayStats['today_available_slots'] }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-600">新規顧客数</span>
                    <span id="period-customers" class="font-semibold text-gray-900">{{ $todayStats['today_customers'] }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div id="recent-activity" class="space-y-3">
                ...
                <div class="flex items-center justify-between py-3 border-b border-gray-100 last:border-b-0">
                    <div class="flex-1">
                        <p class="text-sm font-medium text-gray-900">{{ $reservation->customer->name }}</p>
                        <p class="text-xs text-gray-500">{{ $reservation->timeSlot->date }} {{ substr($reservation->timeSlot->start_time, 0, 5) }}-{{ substr($reservation->timeSlot->end_time, 0, 5) }}</p>
                    </div>
                    <div class="text-right">
                        <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full 
                            {{ $reservation->status === 'confirmed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                            {{ $reservation->status === 'confirmed' ? '確定' : '保留' }}
                        </span>
                        <p class="text-xs text-gray-500 mt-1">{{ $reservation->created_at->format('m/d H:i') }}</p>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="font-semibold text-gray-900">{{ $systemInfo['app_env'] }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-600">タイムゾーン</span>
                    <span class="font-semibold text-gray-900">{{ $systemInfo['timezone'] }}</span>
                </div>
            </div>
        </div>
    </div>
