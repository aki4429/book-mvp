        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-gray-500">新規作成</span>
                </div>
            </li>
        </ol>
    </nav>
...
<div class="bg-white shadow-sm rounded-lg">
    <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg font-medium leading-6 text-gray-900">新規ユーザー作成</h3>
        <p class="mt-1 max-w-2xl text-sm text-gray-500">
            新しい管理者ユーザーまたは一般ユーザーを作成します。
        </p>
    </div>
    
    <form action="{{ route('admin.users.store') }}" method="POST" class="px-6 py-4 space-y-6">
        @csrf
