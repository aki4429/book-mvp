    ...
    <nav class="flex-1 px-2 py-4 space-y-2">
      <a href="{{ route('admin.dashboard') }}"
        class="flex items-center px-3 py-2 rounded-lg
                      hover:bg-gray-200 {{ request()->routeIs('admin.dashboard') ? 'bg-gray-200 font-semibold' : '' }}">
      ...
      <a href="{{ route('admin.admin-dashboard.index') }}"
        class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-200
          {{ request()->routeIs('admin.admin-dashboard.*') ? 'bg-gray-200 font-semibold' : '' }}">
        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor">
      ...
      <a href="{{ route('admin.user-manager.index') }}"
        class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-200
          {{ request()->routeIs('admin.user-manager.*') ? 'bg-gray-200 font-semibold' : '' }}">
        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor">
          <use href="#users-icon" />
        </svg>
      ...
      <a href="{{ route('admin.bulk-timeslots.index') }}"
        class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-200
          {{ request()->routeIs('admin.bulk-timeslots.*') ? 'bg-gray-200 font-semibold' : '' }}">
        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor">
      ...
      <a href="{{ route('admin.preset-manager.index') }}"
        class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-200
          {{ request()->routeIs('admin.preset-manager.*') ? 'bg-gray-200 font-semibold' : '' }}">
        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor">
      ...
      <a href="{{ route('admin.settings-manager.index') }}"
        class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-200
          {{ request()->routeIs('admin.settings-manager.*') ? 'bg-gray-200 font-semibold' : '' }}">
        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor">
